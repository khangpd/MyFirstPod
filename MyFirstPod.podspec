...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/MyFirstPod/MyFirstPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'MyFirstPod' => 'phamkhang050@gmail.com' }
  s.source           = { :git => 'https://github.com/MyFirstPod/MyFirstPod.git', :tag => s.version.to_s }
